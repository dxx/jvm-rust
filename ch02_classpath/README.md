...
```shell
jvm-rust ❯ cargo build -p ch02_classpath --release
```

#### 运行：

```shell
jvm-rust ❯ ./target/release/ch02_classpath -cp "/Library/Java/JavaVirtualMachines/jdk1.8.0_181.jdk/Contents/Home/jre" java.lang.Object
