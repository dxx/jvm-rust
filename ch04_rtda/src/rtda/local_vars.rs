...
impl LocalVars {
    ...
    pub fn set_ref(&mut self, index: usize, _ref: Option<Box<Object>>) {
        self.slots[index]._ref = _ref;
    }

    pub fn get_ref(&self, index: usize) -> Option<&Box<Object>> {
        self.slots[index]._ref.as_ref()
    }
